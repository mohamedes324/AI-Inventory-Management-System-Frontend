...
export default function ProductSearchInput({ onSelect, onResults, onClear, className = "" }) {
  ...
  const showDropdown = isFocused && query.trim().length > 0 && (suggestions.length > 0 || searching);
