...
import { getSortByParam } from "../types/purchaseOrderTypes";

/**
 * @hook usePurchaseOrders
 * @description Manages purchase order fetching with pagination and filters.
 ...
 */
export const usePurchaseOrders = (initialPageSize = 10) => {
  ...
  const { execute, loading } = useRequest(getPurchaseOrders);
